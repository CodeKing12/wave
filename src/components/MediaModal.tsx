...
export default function MediaModal({ show, media, authToken, onExit }: MediaModalProps) {
    ...
    return (
        <FocusContext.Provider value={focusKey}>
            <div className={`modal-root fixed top-0 bottom-0 left-0 right-0 w-full h-full p-10 bg-black-1 ease-in-out duration-500 opacity-0 invisible -translate-x-20 z-0 ${show ? "!translate-x-0 !opacity-100 !visible !z-50" : ""}`} ref={ref}>
                <FocusLeaf focusedStyles="exit-focus" onEnterPress={exitModal}>
                ...
                <div className="flex justify-center gap-20 h-full">
                    ...
                    <div className="modal-content min-w-[550px] py-10 text-gray-300 overflow-y-scroll hide-scrollbar relative duration-300 ease-in-out"> {/* max-w-[620px] */}
                        <div className="max-w-[620px]">
                            <FocusLeaf focusedStyles="title-focus">
